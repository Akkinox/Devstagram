...
<html lang="en">
    <head>
        ...
        <title>Devstagram - @yield('nav')</title>
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a href="{{route('posts.create')}}" class="flex items-center gap-2 bg-white border p-2
                         text-gray-600 rounded text-sm uppercase font-bold curso-pointer"> 
                        ...
                        <form method="POST" action={{route('logout')}}>
                            ...
                            text-gray-600 text-sm">Cerrar sesión</button>
                        </form>
